...
final class CommandFileSelector
{
    ...
    public function __construct(
        ...
        $this->fileMatcher = new FilePatternMatcher($filePatterns, [], false);
    }

    public function accepts(string $file): bool
    {
        return $this->runtimeSwitch->isEnabled() && $this->fileMatcher->accepts($file);
    }
}
