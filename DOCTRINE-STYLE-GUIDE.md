...
imagery and symbols available to their prose.

It is intentionally independent of any programming language, repository layout, or docblock syntax. Project-specific
coverage, placement, and citation-allocation rules belong in each consuming repository; general code-editing constraints
belong in the [coding guide](DOCTRINE-CODING-GUIDE.md). Translating a completed logion into an image belongs in the
...
**Scripture is the body. Revelation is the voltage. The Second Sun is the vision.**
